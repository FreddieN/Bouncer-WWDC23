...
struct G2: View {
    ...
    var body: some View {
        VStack() {
            ...
            //                )
            //            }
            ViewControllerRepresentableG2(parent: self).frame(width:400,height:400)
...
struct ViewControllerRepresentableG2:
    UIViewControllerRepresentable {
    var parent: G2
    
    func makeUIViewController(context: UIViewControllerRepresentableContext<ViewControllerRepresentableG2>) ->
    ViewControllerG2 {
        let viewController = ViewControllerG2()
    ...
    func updateUIViewController(_ uiViewController: ViewControllerG2, context: Context) {
