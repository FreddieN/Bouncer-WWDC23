...
struct G3: View {
    ...
    var body: some View {
        VStack() {
            ...
            //                )
            //            }
            ViewControllerRepresentableG3(parent: self).frame(width:400,height:400)
...
struct ViewControllerRepresentableG3:
    UIViewControllerRepresentable {
    var parent: G3
    
    func makeUIViewController(context: UIViewControllerRepresentableContext<ViewControllerRepresentableG3>) ->
    ViewControllerG3 {
        let viewController = ViewControllerG3()
    ...
    func updateUIViewController(_ uiViewController: ViewControllerG3, context: Context) {
