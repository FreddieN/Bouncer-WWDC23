    ...
    var body: some View {
        ScrollView {
                ...
                VStack(alignment: .leading) {
                    Text("""
In accordance with the law of conservation of energy, the total energy of a closed system before and after any event must be equal. This principle applies to the case of a ball moving in a gravitational field, where the potential energy due to its position is equal to the sum of its translational and rotational kinetic energy, as well as its rotational potential energy. By substituting the appropriate formulae, the final velocity of the ball can be determined. It is important to note that the total energy of the system, which is the sum of its kinetic and potential energy, remains constant before and after the ball's motion. This fundamental principle in physics underpins many phenomena, from the motion of celestial bodies to the behaviour of subatomic particles. As such, it is a cornerstone of modern science and engineering, with wide-ranging implications.
""")
                    Text("""
