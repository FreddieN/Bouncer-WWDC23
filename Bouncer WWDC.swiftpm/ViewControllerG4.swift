...
public class ViewControllerG4: UIViewController {
    ...
    func setup() {
        ...
        //    
        //}
        for i in stride(from: d_1+d_2, to: (d_3/2)+d_1+d_2, by: 0.2) {
        ...
        observer.position = SCNVector3(x: Float(d_1+d_2+d_3/2), y: 1, z: 3)
